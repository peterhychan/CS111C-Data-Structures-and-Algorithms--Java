public class SecondEntryWayListDriver {
	public static void main(String... args) {
		new SecondEntryWayListDriver().operate();
		System.out.println("SecondEntryWayList operated");
	}	
	private void operate() {
		SecondEntryWayList<Integer> integerList = new SecondEntryWayList<Integer>();
		...
		SecondEntryWayList<String> stringList = new SecondEntryWayList<String>();
